class User < ApplicationRecord
  ...
  has_one :inverse_referenced_registration, class_name: 'ReferencedRegistration', foreign_key: 'user_id', dependent: :destroy

  has_one :inviter, class_name: 'User', through: :inverse_referenced_registration, foreign_key: 'referer_id', source: :referer
